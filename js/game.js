...
enableEndscreenLost = () => {
    if (fullscreen == true) {
      document.getElementById("canvas").style =
        "width: 90%; height: 80vh; border-radius: 20px; background-position: center; background-image: url('img/9_intro_outro_screens/game_over/game_over.png')";
    } else {
      document.getElementById("canvas").style =
 ...
 */
noFullscreenAlive = () => {
    document.getElementById("canvasContainer").style = "width: 90%; height: 80%";
    document.getElementById("canvas").style =
      "width: 90%; height: 80%; border-radius: 20px; background-image: url('img/9_intro_outro_screens/start/startscreen_2.png'); background-size: cover; background-position: 20%";
    fullscreen = true;
};
...
noFullscreenNotAlive = () => {
    document.getElementById("canvasContainer").style =
        "width: 90%; height: 80%";
    document.getElementById("canvas").style =
        "width: 90%; height: 80%; border-radius: 20px; background-position: center; background-image: url('img/9_intro_outro_screens/game_over/game_over.png')";
    fullscreen = true;
};
